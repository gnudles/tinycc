...
DEF-1750a          = -DTCC_TARGET_1750A -w # disable warnigs
...
TCC_X += riscv64 arm64-osx 1750a
# TCC_X += arm-fpa arm-fpa-ld arm-vfp arm-eabi

# cross libtcc1.a targets to build
LIBTCC1_X = $(filter-out c67 1750a,$(TCC_X))
...
1750a_FILES = $(CORE_FILES) 1750a-gen.c 1750a-link.c 1750a-asm.c tcccoff.c
